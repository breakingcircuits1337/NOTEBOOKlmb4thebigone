# BCs BookNG - Start Here

**BCs BookNG** is a privacy-focused AI research assistant. Upload documents, chat with AI, generate notes, and create podcasts—all with complete control over your data.
...
| Feature | BCs BookNG | Notebook LM |
|---------|---|---|
