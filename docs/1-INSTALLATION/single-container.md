...
> **Alternative Registry:** Images available on both Docker Hub (`breakingcircuits1337/bcs-book-ng:v1-latest-single`) and GitHub Container Registry (`ghcr.io/breakingcircuits1337/bcs-book-ng:v1-latest-single`).
...
2. Add `breakingcircuits1337/bcs-book-ng:v1-latest-single`
3. Set environment variables
4. Deploy

**Render:**
1. Create new Web Service
2. Use Docker image: `breakingcircuits1337/bcs-book-ng:v1-latest-single`
3. Set environment variables in dashboard
4. Configure persistent disk for `/app/data` and `/mydata`

**DigitalOcean App Platform:**
1. Create new app from Docker Hub
2. Use image: `breakingcircuits1337/bcs-book-ng:v1-latest-single`
3. Set port to 8502
...
2. Image: `breakingcircuits1337/bcs-book-ng:v1-latest-single`
3. Port: 8502
4. Add environment variables
