# AI Context & RAG - How BCs BookNG Uses Your Research

BCs BookNG uses different approaches to make AI models aware of your research depending on the feature. This section explains **RAG** (used in Ask) and **full-content context** (used in Chat).
...
When you upload a source, BCs BookNG prepares it for retrieval:
...
BCs BookNG provides two different search strategies for different goals.
...
Here's where BCs BookNG is different: **You decide what the AI sees.**
...
BCs BookNG's RAG approach gives you something you don't get with ChatGPT or Claude directly:
...
BCs BookNG gives you **two ways** to work with AI:
