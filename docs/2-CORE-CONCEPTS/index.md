...
Before diving into how to use BCs BookNG, it's important to understand **how it thinks**. These core concepts explain the "why" behind the design.

## The Five Mental Models

### 1. [Notebooks, Sources, and Notes](notebooks-sources-notes.md)
How BCs BookNG organizes your research. Understand the three-tier container structure and how information flows from raw materials to finished insights.
...
How BCs BookNG makes AI aware of your research - two different approaches.
...
Why BCs BookNG has different interaction modes and when to use each one.
...
Why BCs BookNG can turn research into audio and why this matters.
...
- **You're new to BCs BookNG** — Start here to understand how the system works conceptually before learning the features
...
BCs BookNG is built on a simple insight: **Your research deserves to stay yours**.
