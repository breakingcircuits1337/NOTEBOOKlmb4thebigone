...
BCs BookNG uses SurrealDB for its database needs. 

---

## Default Configuration

BCs BookNG should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as BCs BookNG (recommended)
...
### DB running in the host machine and BCs BookNG running in Docker
...
### BCs BookNG and Surreal are running on the same machine
