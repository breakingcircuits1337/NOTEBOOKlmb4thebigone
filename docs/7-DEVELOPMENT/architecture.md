# BCs BookNG Architecture

## High-Level Overview

BCs BookNG follows a three-tier architecture with clear separation of concerns:
...
LangGraph is a state machine library that orchestrates multi-step AI workflows. BCs BookNG uses five core workflows:
