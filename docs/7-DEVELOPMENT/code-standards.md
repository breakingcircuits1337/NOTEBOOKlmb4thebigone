...
This document outlines coding standards and best practices for BCs BookNG contributions. All code should follow these guidelines to ensure consistency, readability, and maintainability.
...
managing research notebooks within the BCs BookNG system.
"""
```
...
class Notebook(BaseModel):
    ...
    Notebooks are the primary organizational unit in BCs BookNG, allowing
