...
Get BCs BookNG running locally in 5 minutes.
...
git remote add upstream https://github.com/breakingcircuits1337/BCs-Book_NG.git
```
...
- **Frontend**: http://localhost:3000 → BCs BookNG UI
...
- **First Issue?** Pick a [good first issue](https://github.com/breakingcircuits1337/BCs-Book_NG/issues?q=label%3A%22good+first+issue%22)
