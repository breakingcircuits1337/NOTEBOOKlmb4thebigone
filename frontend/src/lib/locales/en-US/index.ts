export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The BCs BookNG API server could not be reached",
    ...
    docLink: "BCs BookNG Documentation",
  ...
  sources: {
    ...
    createCodeSnippetBtn: 'Create Snippet',
    language: 'Language',
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow BCs BookNG to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of BCs BookNG is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    desc: "Configure AI models for different purposes across BCs BookNG",
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across BCs BookNG",
    missingRequiredModels: "Missing required models: {models}. BCs BookNG may not function properly without these.",
