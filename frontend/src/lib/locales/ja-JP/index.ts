export const jaJP = {
  ...
  connectionErrors: {
    ...
    apiDesc: "BCs BookNG APIサーバーに到達できませんでした",
  ...
  sources: {
    ...
    editNote: 'ノートを編集',
    createNote: 'ノートを作成',
    editCodeSnippet: 'コードスニペットを編集',
    createCodeSnippet: 'コードスニペットを作成',
    createCodeSnippetBtn: 'スニペットを作成',
    language: '言語',
    addTitle: 'タイトルを追加...',
    untitledNote: '無題のノート',
  ...
  settings: {
    ...
    filesHelp: "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはBCs BookNGがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  advanced: {
    ...
    updateAvailableDesc: "BCs BookNGの新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  models: {
    title: "モデル管理",
    desc: "BCs BookNG全体で異なる目的に使用するAIモデルを設定",
    ...
    defaultAssignmentsDesc: "BCs BookNG全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {models}。これらがないとBCs BookNGが正しく機能しない可能性があります。",
