export const ptBR = {
  common: {
    ...
    addCodeSnippet: "Adicionar Trecho de Código",
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do BCs BookNG não pôde ser alcançado",
    ...
    docLink: "Documentação do BCs BookNG",
  ...
  sources: {
    ...
    editCodeSnippet: "Editar Trecho de Código",
    createCodeSnippet: "Criar Trecho de Código",
    createCodeSnippetBtn: "Criar Trecho",
    language: "Linguagem",
    addTitle: "Adicionar título...",
    untitledNote: "Nota Sem Título",
    untitledSnippet: "Trecho Sem Título",
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o BCs BookNG exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do BCs BookNG está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    desc: "Configure modelos de IA para diferentes propósitos no BCs BookNG",
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no BCs BookNG",
    missingRequiredModels: "Modelos obrigatórios ausentes: {models}. O BCs BookNG pode não funcionar corretamente sem eles.",
