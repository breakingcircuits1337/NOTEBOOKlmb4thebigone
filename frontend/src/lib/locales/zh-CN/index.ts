export const zhCN = {
  ...
  connectionErrors: {
    ...
    apiDesc: "无法访问 BCs BookNG API 服务器",
    dbTitle: "数据库连接失败",
  ...
  sources: {
    ...
    createCodeSnippetBtn: '创建片段',
    language: '语言',
    addTitle: '添加标题...',
    untitledNote: '无标题笔记',
    untitledSnippet: '无标题片段',
  ...
  models: {
    title: "模型管理",
    desc: "配置用于 BCs BookNG 不同用途的 AI 模型",
    ...
    defaultAssignmentsDesc: "配置用于 BCs BookNG 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有这些模型，BCs BookNG 可能无法正常运行。",
