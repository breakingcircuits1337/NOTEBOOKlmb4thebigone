export const zhTW = {
  ...
  connectionErrors: {
    ...
    apiDesc: "無法存取 BCs BookNG API 伺服器",
    dbTitle: "資料庫連線失敗",
  ...
  sources: {
    ...
    editNote: '編輯筆記',
    createNote: "新增筆記",
    editCodeSnippet: '編輯程式碼片段',
    createCodeSnippet: '新增程式碼片段',
    createCodeSnippetBtn: '新增片段',
    language: '語言',
    addTitle: '新增標題...',
    untitledNote: '無標題筆記',
    untitledSnippet: '無標題片段',
  ...
  advanced: {
    ...
    updateAvailableDesc: "BCs BookNG 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  models: {
    title: "模型管理",
    desc: "設定用於 BCs BookNG 不同用途的 AI 模型",
    ...
    defaultAssignmentsDesc: "設定用於 BCs BookNG 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{models}。如果没有這些模型，BCs BookNG 可能無法正常運行。",
